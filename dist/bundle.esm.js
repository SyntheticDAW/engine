function B(t){switch(t){case"u8":case"i8":case"bool":return 1;case"u16":case"i16":return 2;case"u32":case"i32":case"f32":return 4;case"u64":case"i64":case"f64":return 8}}function w(t,e,n,o){let r=e.buffer,a=e.byteOffset+n;switch(t){case"u8":return new Uint8Array(r,a,o);case"i8":return new Int8Array(r,a,o);case"bool":return new Uint8Array(r,a,o);case"u16":return new Uint16Array(r,a,o);case"i16":return new Int16Array(r,a,o);case"u32":return new Uint32Array(r,a,o);case"i32":return new Int32Array(r,a,o);case"f32":return new Float32Array(r,a,o);case"f64":return new Float64Array(r,a,o);case"u64":return new BigUint64Array(r,a,o);case"i64":return new BigInt64Array(r,a,o)}}function x(t,e){if(typeof t=="bigint")return t;if(!Number.isSafeInteger(t))throw new Error("Number cannot safely fit in 64 bits");if(e){if(t<-9223372036854776e3||t>9223372036854776e3)throw new Error("Number out of i64 range")}else if(t<0||t>18446744073709552e3)throw new Error("Number out of u64 range");return BigInt(t)}function U(t){let e=0,n={},o=[];for(let[a,i]of Object.entries(t)){let p,s=1,d=i.match(/^([a-z0-9]+)\[(\d+)\]$/i);d?(p=d[1],s=parseInt(d[2],10)):p=i;let h=B(p)*s;B(p)===8&&(e=e+7&-8),n[a]={type:i,offset:e,size:h,arrayLength:s>1?s:void 0},o.push(a),e+=h}let r={_size:e,_fields:n,fieldOrder:o,Make(a,i,p){let s=p??a.malloc(r._size),d=s.ptr,h=!1,y=new Proxy({ptr:d,region:s,_type:r,get destroyed(){return h},read(c){if(h)throw new Error("Accessing destroyed struct");let u=n[c];if(!u)throw new Error("Invalid field "+c);let l=u.arrayLength?u.type.replace(/\[\d+\]$/,""):u.type;if(u.arrayLength)return w(l,s,u.offset,u.arrayLength);let f=w(l,s,u.offset,1);return l==="bool"?!!(Number(f[0])^0):f[0]},write(c,u){if(h)throw new Error("Writing to destroyed struct");let l=n[c];if(!l)throw new Error("Invalid field "+c);let f=l.arrayLength?l.type.replace(/\[\d+\]$/,""):l.type;if(l.arrayLength){let m=Array.isArray(u)?u:Array.from(u);if(m.length!==l.arrayLength)throw new Error(`Field ${c} expects array of length ${l.arrayLength}`);for(let b=0;b<l.arrayLength;b++){let A=w(f,s,l.offset+b*B(f),1);f==="bool"?A[0]=m[b]?1:0:f==="u64"?A[0]=x(m[b],!1):f==="i64"?A[0]=x(m[b],!0):A[0]=m[b]}}else{let m=w(f,s,l.offset,1);f==="bool"?m[0]=u?1:0:f==="u64"?m[0]=x(u,!1):f==="i64"?m[0]=x(u,!0):m[0]=u}},destroy(){if(h)throw new Error("Struct already destroyed");a.free(s),h=!0}},{get(c,u){return u in c?c[u]:c.read(u.toString())},set(c,u,l){return u in c||c.write(u.toString(),l),!0}});if(i)for(let[c,u]of Object.entries(i))y.write(c,u);return y}};return r}var q=-1,k=class{id;plugin;active;buffer;constructor(e){this.id=++q,this.plugin=e,this.buffer=new Float32Array(128),this.active=!0}process128(e){return this.plugin.process128(this.buffer,e)}};function I(t,e,n,o){if(o.length<n)throw new Error("Output buffer too small");for(let r=0;r<n;r++)o[r]=0;for(let r of t)for(let a=0;a<n;a++){let i=e+a;i<r.length&&(o[a]+=r[i])}for(let r=0;r<n;r++){let a=o[r];o[r]=a>1?1:a<-1?-1:a}}var C=`
