var synth=(()=>{var _=Object.defineProperty;var j=Object.getOwnPropertyDescriptor;var J=Object.getOwnPropertyNames;var Y=Object.prototype.hasOwnProperty;var K=(t,e)=>{for(var n in e)_(t,n,{get:e[n],enumerable:!0})},Q=(t,e,n,a)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of J(e))!Y.call(t,r)&&r!==n&&_(t,r,{get:()=>e[r],enumerable:!(a=j(e,r))||a.enumerable});return t};var X=t=>Q(_({},"__esModule",{value:!0}),t);var ne={};K(ne,{Allocators:()=>re,ExamplePlugins:()=>te,Track:()=>F,WorkletHelper:()=>y,Workspace:()=>I,createSampleSAB:()=>B,createSampleView:()=>k,createWorkletBlob:()=>L,gainClamped:()=>P,gainDecibels:()=>H,hex2str:()=>R,hexToPacked:()=>W,packRGBA:()=>D,packedToHex:()=>O,playSamples:()=>q,rmsGetDecibels:()=>V,sampleToSeconds:()=>G,str2hex:()=>C,struct:()=>U,sumBlocks:()=>E,sumBlocksMutate:()=>S,sumTracks:()=>z,unpackRGBA:()=>N});function M(t){switch(t){case"u8":case"i8":case"bool":return 1;case"u16":case"i16":return 2;case"u32":case"i32":case"f32":return 4;case"u64":case"i64":case"f64":return 8}}function w(t,e,n,a){let r=e.buffer,o=e.byteOffset+n;switch(t){case"u8":return new Uint8Array(r,o,a);case"i8":return new Int8Array(r,o,a);case"bool":return new Uint8Array(r,o,a);case"u16":return new Uint16Array(r,o,a);case"i16":return new Int16Array(r,o,a);case"u32":return new Uint32Array(r,o,a);case"i32":return new Int32Array(r,o,a);case"f32":return new Float32Array(r,o,a);case"f64":return new Float64Array(r,o,a);case"u64":return new BigUint64Array(r,o,a);case"i64":return new BigInt64Array(r,o,a)}}function x(t,e){if(typeof t=="bigint")return t;if(!Number.isSafeInteger(t))throw new Error("Number cannot safely fit in 64 bits");if(e){if(t<-9223372036854776e3||t>9223372036854776e3)throw new Error("Number out of i64 range")}else if(t<0||t>18446744073709552e3)throw new Error("Number out of u64 range");return BigInt(t)}function U(t){let e=0,n={},a=[];for(let[o,u]of Object.entries(t)){let p,i=1,d=u.match(/^([a-z0-9]+)\[(\d+)\]$/i);d?(p=d[1],i=parseInt(d[2],10)):p=u;let h=M(p)*i;M(p)===8&&(e=e+7&-8),n[o]={type:u,offset:e,size:h,arrayLength:i>1?i:void 0},a.push(o),e+=h}let r={_size:e,_fields:n,fieldOrder:a,Make(o,u,p){let i=p??o.malloc(r._size),d=i.ptr,h=!1,g=new Proxy({ptr:d,region:i,_type:r,get destroyed(){return h},read(c){if(h)throw new Error("Accessing destroyed struct");let s=n[c];if(!s)throw new Error("Invalid field "+c);let l=s.arrayLength?s.type.replace(/\[\d+\]$/,""):s.type;if(s.arrayLength)return w(l,i,s.offset,s.arrayLength);let f=w(l,i,s.offset,1);return l==="bool"?!!(Number(f[0])^0):f[0]},write(c,s){if(h)throw new Error("Writing to destroyed struct");let l=n[c];if(!l)throw new Error("Invalid field "+c);let f=l.arrayLength?l.type.replace(/\[\d+\]$/,""):l.type;if(l.arrayLength){let m=Array.isArray(s)?s:Array.from(s);if(m.length!==l.arrayLength)throw new Error(`Field ${c} expects array of length ${l.arrayLength}`);for(let b=0;b<l.arrayLength;b++){let A=w(f,i,l.offset+b*M(f),1);f==="bool"?A[0]=m[b]?1:0:f==="u64"?A[0]=x(m[b],!1):f==="i64"?A[0]=x(m[b],!0):A[0]=m[b]}}else{let m=w(f,i,l.offset,1);f==="bool"?m[0]=s?1:0:f==="u64"?m[0]=x(s,!1):f==="i64"?m[0]=x(s,!0):m[0]=s}},destroy(){if(h)throw new Error("Struct already destroyed");o.free(i),h=!0}},{get(c,s){return s in c?c[s]:c.read(s.toString())},set(c,s,l){return s in c||c.write(s.toString(),l),!0}});if(u)for(let[c,s]of Object.entries(u))g.write(c,s);return g}};return r}var Z=-1,F=class{id;plugin;active;buffer;constructor(e){this.id=++Z,this.plugin=e,this.buffer=new Float32Array(128),this.active=!0}process128(e){return this.plugin.process128(this.buffer,e)}};function S(t,e,n,a){if(a.length<n)throw new Error("Output buffer too small");for(let r=0;r<n;r++)a[r]=0;for(let r of t)for(let o=0;o<n;o++){let u=e+o;u<r.length&&(a[o]+=r[u])}for(let r=0;r<n;r++){let o=a[r];a[r]=o>1?1:o<-1?-1:o}}var ee=`
